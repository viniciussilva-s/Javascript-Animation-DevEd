function init (){
    ...
    function nextSlide(pageNumber){
        ...
        .to(portofolio,0.3,{background: bg[pageNumber] })
    ...
    // OPTIONAL
       ...
       document.addEventListener('touchpad',throttle(scrollChange,1500)); 
    ...
    const hblist = document.querySelectorAll('.menu line');
    ...
    .fromTo(hblist,0.2,{stroke:"white"},{stroke:"black"},'-=1')
